...
var file_server_services_liefer_proto_rawDesc = []byte{
...
var file_server_services_liefer_proto_goTypes = []interface{}{
...
func file_server_services_liefer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_server_services_liefer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_server_services_liefer_proto_rawDesc = nil
